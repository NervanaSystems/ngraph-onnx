...
function run_backend_test() {
    ...
    local ngraph_ci_dir="${2}"
    local backend="${3}"
    local ngraph_onnx_dir="${DOCKER_HOME}/ngraph/${ngraph_ci_dir}/${NGRAPH_REPO_DIR_NAME}"
