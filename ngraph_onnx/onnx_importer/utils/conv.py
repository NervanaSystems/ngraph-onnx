...
def get_kernel_shape(onnx_node):  # type:  (NodeWrapper) -> Tuple[int, ...]
    """
...
def get_strides(onnx_node):  # type: (NodeWrapper) -> Tuple[int, ...]
    """
...
def get_dilations(onnx_node):  # type: (NodeWrapper) -> Tuple[int, ...]
    """
